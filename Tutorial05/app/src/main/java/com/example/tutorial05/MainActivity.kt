...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtStudentId = findViewById(R.id.editTextStdId)
        spnYear = findViewById(R.id.spinnerYear)
        spnSemester = findViewById(R.id.spinnerSem)
        cbAgree = findViewById(R.id.checkBox)
        tvYear = findViewById(R.id.textView)
        tvSemester = findViewById(R.id.textView2)
    }
